...
<?php
		$earliestTs = isset($NTS_VIEW['availability']['resources'][$e->getId()]) ? $NTS_VIEW['availability']['resources'][$e->getId()] : 0;
?>
	<li>
		<h3><a href="<?php echo ntsLink::makeLink('-current-', 'select', array('id' => $e->getId()) ); ?>"><?php echo $e->getProp('title'); ?></a></h3>
<?php
