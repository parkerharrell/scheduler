...
<?php if( $NTS_VIEW['appsCount'] ) : ?>
	<p>
	<b><?php echo ntsView::objectTitle($object); ?></b>: <a href="<?php echo ntsLink::makeLink('admin/appointments/browse', '', array('resource' => $NTS_VIEW['object']->getId())); ?>"><?php echo M('There are [b]{APPS_COUNT}[/b] appointment(s)', array('APPS_COUNT' => $NTS_VIEW['appsCount']) ); ?></a>
	<p>
